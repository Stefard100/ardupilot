...
public:
    ...
    typedef enum
    {
        ...
        k_actuator5             = 188,
        k_actuator6             = 189,
        k_tiltMotorLeftVec      = 190,   // vectored thrust, left tilt with independent attitude vectoring
        k_tiltMotorRightVec     = 191,   // vectored thrust, right tilt with independent attitude vectoring
